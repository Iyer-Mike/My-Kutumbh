      ...
      {sent ? (
        <div className="space-y-4 text-center">
          <div
            ...
            style={{ background: "#EAF2E8", border: "1px solid #C6DFBE" }}
          >
            <p className="text-2xl mb-2">📬</p>
            <p className="font-semibold text-sm" style={{ color: "#1C2B1C" }}>Check your inbox</p>
            <p className="text-sm mt-1" style={{ color: "#5A6055" }}>
              We&apos;ve sent a password reset link to <strong>{email}</strong>.
              Check your spam folder if it doesn&apos;t arrive in a minute.
            </p>
          </div>
          <Link href="/login" className="block text-sm font-semibold" style={{ color: "#4A7C44" }}>
            ← Back to sign in
          </Link>
        </div>
      ) : (
        <>
          ...
          <p className="text-center text-sm mt-6">
            <Link href="/login" className="font-semibold" style={{ color: "#4A7C44" }}>
              ← Back to sign in
            </Link>
          </p>
        </>
